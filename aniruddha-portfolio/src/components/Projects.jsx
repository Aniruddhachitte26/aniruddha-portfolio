            ...
            <div className="container mx-auto px-6">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex justify-center mb-12 flex-wrap">
                        <div className="flex space-x-2 bg-lightNavy p-2 rounded-lg shadow-md">
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex space-x-4">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-6 py-2 bg-navy text-white font-medium rounded-md flex items-center transition hover:bg-navy/80"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-6 py-2 border-2 border-navy text-navy font-medium rounded-md flex items-center transition hover:bg-navy/10"
                                >
