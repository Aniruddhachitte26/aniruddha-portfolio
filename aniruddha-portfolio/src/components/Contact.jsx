...
const Contact = () => {
    ...
    return (
        <section id="contact" className="pt-6 pb-20 lg:pt-12 lg:pb-32 bg-cream">
                            ...
                            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input
                                                ...
                                                required
                                                className="w-full px-4 py-3 bg-lightNavy border border-slate/20 rounded-lg focus:border-teal focus:ring-1 focus:ring-teal outline-none transition-all text-navy"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            required
                                            className="w-full px-4 py-3 bg-lightNavy border border-slate/20 rounded-lg focus:border-teal focus:ring-1 focus:ring-teal outline-none transition-all text-navy resize-none"
                                        ></textarea>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`w-full px-6 py-3 bg-transparent border-2 border-teal text-teal font-medium rounded-lg transition-all flex items-center justify-center 
